...
class FaultyTerminal {
  constructor(container, options = {}) {
    ...
    this.scale = options.scale !== undefined ? options.scale : 1.5;
    this.gridMul = options.gridMul || [2, 1];
    this.digitSize = options.digitSize !== undefined ? options.digitSize : 1.2;
    this.timeScale = options.timeScale !== undefined ? options.timeScale : 1;
    this.pause = options.pause !== undefined ? options.pause : false;
    this.scanlineIntensity = options.scanlineIntensity !== undefined ? options.scanlineIntensity : 1;
    this.glitchAmount = options.glitchAmount !== undefined ? options.glitchAmount : 1;
    this.flickerAmount = options.flickerAmount !== undefined ? options.flickerAmount : 1;
    this.noiseAmp = options.noiseAmp !== undefined ? options.noiseAmp : 1;
    this.chromaticAberration = options.chromaticAberration !== undefined ? options.chromaticAberration : 0;
    this.dither = options.dither !== undefined ? options.dither : 0;
    this.curvature = options.curvature !== undefined ? options.curvature : 0;
    ...
    this.pageLoadAnimation = options.pageLoadAnimation !== undefined ? options.pageLoadAnimation : false;
  ...
  init() {
    if (typeof ogl === 'undefined') {
      console.error('ogl WebGL library is not loaded. FaultyTerminal cannot start.');
      return;
    }
    
    const { Renderer, Program, Mesh, Color, Triangle } = ogl;
    
    const tintVec = hexToRgb(this.tint);
    ...
    this.program = new Program(gl, {
      ...
      uniforms: {
        ...
        uMouse: {
          value: new Float32Array([this.smoothMouse.x, this.smoothMouse.y])
        },
